...
import com.huawei.dvkitdemo.DvKitDemoActivity;
import com.huawei.dvkitdemo.R;
...
public class RegitsterCameraAPI2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button changeRotate = findViewById(R.id.change);
        Button notChangeRotate = findViewById(R.id.nchange);

        Button needMirror = findViewById(R.id.mirror);
        Button notNeedMirror = findViewById(R.id.nmirror);

        changeRotate.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        notChangeRotate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dealNotChangeRotate();
            }
        ...
        needMirror.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dealNeedMirror();
            }
        ...
        notNeedMirror.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dealNoNeedMirror();
            }
    ...
    private void dealChangeRotate() {
        Map<String, Object> params = new HashMap<String, Object>();
        DvKitDemoActivity dvKitDemoActivity = new DvKitDemoActivity();
        String propName = getPropName();
        params.put(Constants.CAMERA_POSITION, propName);
        params.put(Constants.AUTO_ORIENTATION, Constants.AUTO_ORIENTATION_ENABLE);
        VirtualDevice device = dvKitDemoActivity.getDevice();
        device.setData(Constants.CAMERA_CONFIG, params);
    }

    private void dealNotChangeRotate() {
        Map<String, Object> params = new HashMap<String, Object>();
        DvKitDemoActivity dvKitDemoActivity = new DvKitDemoActivity();
        String propName = getPropName();
        params.put(Constants.CAMERA_POSITION, propName);
        params.put(Constants.AUTO_ORIENTATION, Constants.AUTO_ORIENTATION_DISABLE);
        VirtualDevice device = dvKitDemoActivity.getDevice();
        device.setData(Constants.CAMERA_CONFIG, params);
    }

    private void dealNeedMirror() {
        Map<String, Object> params = new HashMap<String, Object>();
        DvKitDemoActivity dvKitDemoActivity = new DvKitDemoActivity();
        String propName = getPropName();
        params.put(Constants.CAMERA_POSITION, propName);
        params.put(Constants.DO_MIRROR, Constants.DO_MIRROR_ENABLE);
        VirtualDevice device = dvKitDemoActivity.getDevice();
        device.setData(Constants.CAMERA_CONFIG, params);
    }

    private void dealNoNeedMirror() {
        Map<String, Object> params = new HashMap<String, Object>();
        DvKitDemoActivity dvKitDemoActivity = new DvKitDemoActivity();
        String propName = getPropName();
        params.put(Constants.CAMERA_POSITION, propName);
        params.put(Constants.DO_MIRROR, Constants.DO_MIRROR_DISABLE);
        VirtualDevice device = dvKitDemoActivity.getDevice();
        device.setData(Constants.CAMERA_CONFIG, params);
    }
